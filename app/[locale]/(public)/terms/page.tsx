    ...
    <>
      ...
      <div className="tp-body">
          ...
          <div className="tp-wrap" style={{ maxWidth: 1100 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
              <a href={`/${locale}`} style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
                <BrandMark size={24} />
                <span className="tp-serif" style={{ fontSize: 17, color: 'var(--cream)' }}>Mizan</span>
              </a>
        ...
        <div className="tp-wrap" style={{ position: 'relative', zIndex: 1, padding: '64px 32px 96px' }}>
          ...
          <h2 className="tp-h2">What Mizan is</h2>
          <p className="tp-p">Mizan is an AI-powered Zakat assistant designed to help Muslims calculate their annual Zakat obligation. It is an educational and informational tool built on classical Islamic scholarship across the four Sunni madhahib.</p>
          <p className="tp-p">Mizan is <strong style={{ color: 'var(--cream)' }}>not a fatwa</strong> and does not constitute a religious ruling specific to your personal situation. For complex or unusual circumstances, you should consult a qualified Islamic scholar.</p>

          <h2 className="tp-h2">Using Mizan</h2>
          <ul className="tp-ul">
            ...
            <li>You may not use Mizan for any unlawful purpose</li>
            <li>You may not attempt to reverse-engineer, copy, or replicate Mizan&apos;s systems</li>
            <li>One account per person — you may not share accounts</li>
          </ul>

          <h2 className="tp-h2">Accuracy and liability</h2>
          <p className="tp-p">Mizan makes every effort to provide accurate Zakat calculations based on established Islamic jurisprudence and live market data. However, we make no guarantee that calculations are free from error or are appropriate for every individual&apos;s unique circumstances.</p>
          <p className="tp-p">Mizan is provided &ldquo;as is&rdquo; without warranties of any kind. We are not liable for any financial decisions made based on Mizan&apos;s output. The obligation to verify your Zakat rests with you and, if needed, a qualified scholar.</p>

          <h2 className="tp-h2">Intellectual property</h2>
          <p className="tp-p">All content, design, and code within Mizan is the intellectual property of its creators. You may not reproduce, distribute, or create derivative works from Mizan&apos;s content without explicit written permission.</p>
          ...
          <p className="tp-p">We may update these terms from time to time. Continued use of Mizan after changes are posted constitutes acceptance of the updated terms. We will notify registered users of material changes by email.</p>
